...
CREATE TABLE IF NOT EXISTS `config_info` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_configinfo_datagrouptenant` (`data_id`(191),`group_id`,`tenant_id`)
...
CREATE TABLE IF NOT EXISTS `config_info_aggr` (
  ...
  `tenant_id` varchar(128) DEFAULT '' COMMENT '租户字段',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_configinfoaggr_datagrouptenantdatum` (`data_id`(191),`group_id`,`tenant_id`,`datum_id`(191))
